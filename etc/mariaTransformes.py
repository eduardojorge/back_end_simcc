...
hugModel = "alpindale/goliath-120b"

mariaModel = AutoModelForCausalLM.from_pretrained(hugModel)
mariaTokenizer = AutoTokenizer.from_pretrained(hugModel, padding_side='left')
...
for step in range(5):
    ...
    chat_history_ids = mariaModel.generate(
        bot_input_ids, max_length=512, pad_token_id=mariaTokenizer.eos_token_id
    )
