...
if __name__ == "__main__":
    ...
    logging.basicConfig(
        filename="/home/ejorge/simcc/back_end_simcc/Log/logfile_SOAP_Lattes.log",
        filemode="w",
        format=Log_Format,
        level=logging.DEBUG,
    )
    ...
    for i, infos in df.iterrows():
        ...
        salvarCV(
            lattes_id,
            "/home/eduardomfjorge/hop/config/projects/Jade-Extrator-Hop/metadata/dataset/xml/curriculos",
        )
        x = x + 1
    print("Fim " + str(x))
