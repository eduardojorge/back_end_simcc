...
def article_prod(Data):
    ...
    df_ind_prod_base_article = df_ind_prod_base_article.pivot(
        index=["year"], columns=["qualis"], values=["count_article"]
    )
    df_ind_prod_base_article = df_ind_prod_base_article.reset_index()
